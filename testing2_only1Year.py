...
for line in dataFile:
    ...
    # #     break
    if(not (str(date2.dataList[0]) == yearToLookAt)):
...
energyConsFig = figure(width = 2000, title = "Daily Energy Consumption vs. Time in Romania", x_axis_label = "Time", y_axis_label = "Energy (Megawatts) * " + str(divisionReduce))
...
energyConsFig.text(x = 0-220, y= height-100, text = ['Energy Consumption'], text_font_size = "15px", text_color = "red")
...
energyConsFig.text(x = 0-220, y= height-100-100, text = ['Energy Production'], text_font_size = "15px", text_color = "blue")

#nuc, win, hyd, sol
#Fossil Fuels:
energyConsFig.line(dayLineX, ffDayLineY, line_width = 1, color = "brown")
energyConsFig.text(x = 0-220, y= height-300, text = ['Fossil Fuel Production'], text_font_size = "10px", text_color = "brown")

#Nuclear:
energyConsFig.line(dayLineX, nuclearDayLineY, line_width = 1, color = "green")
energyConsFig.text(x = 0-220, y= height-450, text = ['Nuclear Energy Production'], text_font_size = "10px", text_color = "green")

#Wind:
energyConsFig.line(dayLineX, windDayLineY, line_width = 1, color = "grey")
energyConsFig.text(x = 0-220, y= height-600, text = ['Wind Energy Production'], text_font_size = "10px", text_color = "grey")

#Hydro:
energyConsFig.line(dayLineX, hydroDayLineY, line_width = 1, color = "navy")
energyConsFig.text(x = 0-220, y= height-750, text = ['Hydroelectric Energy Production'], text_font_size = "10px", text_color = "navy")

#Solar
energyConsFig.line(dayLineX, solarDayLineY, line_width = 1, color = "orange")
energyConsFig.text(x = 0-220, y= height-900, text = ['Solar Energy Production'], text_font_size = "10px", text_color = "orange")
